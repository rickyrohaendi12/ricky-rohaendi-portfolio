    ...
    <footer className="bg-transparent border-t border-purple-500/10 py-12 transition-colors">
      <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left select-none">
        ...
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-md bg-gradient-to-tr from-cyan-500 to-purple-600 flex items-center justify-center text-white font-black text-xs">
            R
          </div>
          <p className="font-mono text-xs text-slate-400">
            Ricky Rohaendi © {year} • <span className="font-semibold text-slate-350">Designer & Software Engineer</span>
          </p>
        </div>
